...
public class DoctorProfilePanel extends JPanel {
    ...
    public DoctorProfilePanel(CardLayout cardLayout, JPanel container, DoctorTableModel tableModel) {
      ...
      //personal details panel
        ...
        addSectionField(personalDetailsPanel, "Gender: *", genderDropDown, null, null, gbc, 2);
     ...
     // ADDITIONAL DETAILS PANEL
      ...
      //consultation fee
        ...
        addSectionField(additionalDetailsPanel,"Start Time: *", startTimeSpinner, "End Time: *", endTimeSpinner,gbc, 2);
    ...
    private void populateFields(Doctor doctor) {
    	header.setText("Doctor Update ID : "+doctor.getId()); //upda
